...
public:
    ...
    IPGetter(Requester *requester1, Replier *replier1, std::string local_network_ip_prefix1="192.168.0.", int timeout1=1000) : requester(requester1), replier(replier1), map(&replier1->map), map_lock(replier1->map_lock), local_network_ip_prefix(local_network_ip_prefix1), timeout(timeout1) {}
};
